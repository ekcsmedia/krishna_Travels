...
class MyPaymentApp extends StatefulWidget {
  late int payment;
  MyPaymentApp({required this.payment});
  @override
...
class _MyPaymentAppState extends State<MyPaymentApp> {
  ...
  get _payment => widget.payment*100;
  ...
  void openCheckout() async {
    var options = {
      'key': 'rzp_test_mpCmtDSUmntg9P',
      'amount': _payment,
      'name': 'Om Sri Krishna Travels',
      'description': 'Monthly Fee',
      'prefill': {'contact': '9283451009', 'email': 'omsrikrishnatravels@gmail.com'},
      'external': {
        'wallets': ['paytm']
      }
    };
