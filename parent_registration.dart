...
class ParentRegistration extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
        home: Scaffold(
            appBar: AppBar(title: Text('Parent Registration Form')),
            body: Center(
...
class RegisterParentState extends State {
  ...
  Future userRegistration() async{
    ...
    // SERVER API URL
    var url = 'https://www.kt.4atoz.com/register_parent.php';
              ...
              child: Column(
                children: <Widget>[
                  ...
                  Padding(
                      ...
                      child: Text('Parent Registration Form',
